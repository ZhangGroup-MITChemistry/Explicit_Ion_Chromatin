...
public:
  ...
  // Exclusion; Remove inter-molecular water contact potential
  // copied from neighbor.h
  int water_exclusion_flag;
  double *k_water_group;
 ...
 private:
  ...
  int  water_exclusion(int, int) const;  // water exclusion; added by Bin; 08-12-2016
