...
AngleListCA::AngleListCA(LAMMPS *lmp) : Angle(lmp) {}

/* ---------------------------------------------------------------------- */

AngleListCA::~AngleListCA()
{
  if (allocated) {
...
void AngleListCA::compute(int eflag, int vflag)
{
  int i1,i2,i3,n,type;
...
void AngleListCA::settings(int narg, char **arg)
{
...
void AngleListCA::coeff(int narg, char **arg)
{
...
double AngleListCA::equilibrium_angle(int i)
{
  return theta0[i];
}
...
void AngleListCA::write_restart(FILE *fp)
{
...
void AngleListCA::read_restart(FILE *fp)
{
  allocate();
...
void AngleListCA::write_data(FILE *fp)
{
...
double AngleListCA::single(int type, int i1, int i2, int i3)
{
  double **x = atom->x;
