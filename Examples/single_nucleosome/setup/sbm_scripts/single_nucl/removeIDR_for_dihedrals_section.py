...
def removeIDR_for_dihedrals_section(inputFile, outputFile):
    ...
    for i in my_lt_range(0, np.shape(dihedrals_interactions)[0], 1):
        dihedral_i = int(dihedrals_interactions[i][0])
        dihedral_j = int(dihedrals_interactions[i][1])
        dihedral_k = int(dihedrals_interactions[i][2])
        dihedral_l = int(dihedrals_interactions[i][3])
